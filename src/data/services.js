...
export const ACTIVITIES = [
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "land",
    name: "Paseo en camello, tequila y almuerzo buffet",
    location: "Rancho en el desierto de Baja",
    tagline: "Cabalgata, degustación y buffet mexicano",
    description:
      "Cabalgata en camello, degustación de tequila y almuerzo buffet mexicano en un solo día de aventura.",
    longDescription:
      "Una experiencia de día completo que combina una cabalgata en camello por el Baja Outback, una degustación guiada de tequila y un almuerzo buffet de cocina mexicana. Incluye transporte redondo desde el hotel y guía bilingüe.",
    price: 1500,
    priceUnit: "persona",
    duration: "5 hrs",
    times: ["09:00"],
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "land",
    name: "Liberación de tortugas al atardecer",
    location: "Rancho Carisuva",
    tagline: "Experiencia de conservación marina",
    description:
      "Programa de conservación de vida silvestre con liberación guiada de crías de tortuga al atardecer.",
    longDescription:
      "Un tour de conservación operado por un rancho local dedicado a la protección de tortugas marinas, donde los visitantes participan directamente en la liberación de crías rumbo al mar, acompañados de una charla educativa al atardecer.",
    price: 1479,
    priceUnit: "persona",
    duration: "4 hrs",
    times: ["16:00"],
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "city",
    name: "Clase de cocina mexicana y mercado local",
    location: "Cabo San Lucas",
    tagline: "Compras de mercado y clase práctica",
    description:
      "Visita a un mercado local para comprar ingredientes y clase práctica de cocina tradicional mexicana.",
    longDescription:
      "Una experiencia cultural que inicia con una visita guiada a un mercado local para seleccionar ingredientes frescos, seguida de una clase práctica de cocina donde se preparan platillos tradicionales mexicanos con un chef local.",
    price: 1800,
    priceUnit: "persona",
    duration: "4 hrs",
    times: ["10:00", "16:00"],
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "land",
    name: "Cabalgata por arenas blancas y tequila",
    location: "Playas de Los Cabos",
    tagline: "Paseo a caballo para todos los niveles",
    description:
      "Paseo a caballo por playas de arena blanca con degustación de tequila, apto para todos los niveles de experiencia.",
    longDescription:
      "Un recorrido a caballo por las playas de arena blanca de Los Cabos, guiado por instructores que adaptan el ritmo a cada jinete, seguido de una degustación de tequila. Apto tanto para principiantes como para jinetes experimentados.",
    price: 1479,
    priceUnit: "persona",
    duration: "2 hrs",
    times: ["09:00", "15:00"],
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "water",
    name: "Kayak al Arco con snorkel",
    location: "Bahía de Cabo San Lucas",
    tagline: "Remo hasta el icónico Arco y Playa del Amor",
    description:
      "Recorrido en kayak hasta el Arco de Cabo San Lucas y Playa del Amor, con parada para snorkel incluida.",
    longDescription:
      "Una salida en kayaks estables hasta el famoso Arco de Cabo San Lucas, con parada en Playa del Amor para practicar snorkel en aguas transparentes. Equipo incluido y guía durante todo el recorrido.",
    price: 1566,
    priceUnit: "persona",
    duration: "2.5 hrs",
    times: ["08:00", "11:00"],
...
export const BOATS = [
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "boats",
    name: "Taxi acuático al Arco y cueva pirata",
    location: "Marina Cabo San Lucas",
    tagline: "El Arco, Playa del Amor y cueva pirata",
    description:
      "Recorrido en taxi acuático desde la marina hasta el Arco, Playa del Amor, Playa del Divorcio y la cueva pirata.",
    longDescription:
      "Salida en taxi acuático desde el puerto deportivo hacia los puntos más emblemáticos de la bahía: el Arco de Cabo San Lucas, Playa del Amor, Playa del Divorcio y la conocida cueva pirata, con guía a bordo.",
    price: 900,
    priceUnit: "persona",
    duration: "2 hrs",
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "boats",
    name: "Fiesta en barco al atardecer",
    location: "Bahía de Cabo San Lucas",
    tagline: "Música en vivo y barra libre",
    description:
      "Fiesta flotante al atardecer con DJ/música en vivo, barra libre y ambiente de vida nocturna sobre el mar.",
    longDescription:
      "Un crucero de ambiente festivo con música en vivo, barra libre y pista de baile a bordo, pensado para quienes buscan la experiencia de vida nocturna más popular de Los Cabos mientras navegan frente a la bahía.",
    price: 1827,
    priceUnit: "persona",
    duration: "3 hrs",
    times: ["17:00"],
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "boats",
    name: "Cena en barco pirata con espectáculo",
    location: "Marina Cabo San Lucas",
    tagline: "Cena, bebidas y show temático",
    description:
      "Crucero al atardecer de temática pirata con cena, bebidas y espectáculo en vivo a bordo.",
    longDescription:
      "Zarpe desde la marina a bordo de un barco de temática pirata para un crucero al atardecer que incluye cena, bebidas y un espectáculo en vivo, pensado para grupos y familias que buscan una experiencia distinta.",
    price: 1722,
    priceUnit: "persona",
    duration: "2 hrs",
    times: ["18:00"],
  ...
  },
  {
    ...
    category: "actividades",
    subcategory: "boats",
    name: "Crucero de lujo con snorkel y almuerzo",
    location: "Bahía de Cabo San Lucas",
    tagline: "Bebidas ilimitadas y mariscos frescos",
    description:
      "Crucero de lujo con parada para snorkel, bebidas ilimitadas y almuerzo de mariscos frescos a bordo.",
    longDescription:
      "Navegación a bordo de un crucero de lujo con parada para practicar snorkel en aguas de la bahía, además de bebidas ilimitadas y un almuerzo de mariscos frescos servido a bordo durante el recorrido.",
    price: 1949,
    priceUnit: "persona",
    duration: "4 hrs",
    times: ["10:00"],
